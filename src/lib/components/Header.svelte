  ...
  <div class="container flex items-center justify-between">
    <a href="/" class="flex items-center group" on:click={closeMenu}>
      <div class="flex items-center">
        <!-- SVG Logo sized to match nav link font size -->
        <div class="w-8 h-8 mr-2">
          <svg viewBox="0 0 1280 769" class="w-full h-full">
            <defs>
              <linearGradient id="linear-gradient" x1="569.3" y1="398.02" x2="712.06" y2="255.26" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#f78f20"/>
                <stop offset="1" stop-color="#eb1289"/>
              </linearGradient>
              <linearGradient id="linear-gradient-2" x1="525.91" y1="354.62" x2="668.67" y2="211.86" href="#linear-gradient"/>
              <linearGradient id="linear-gradient-3" x1="553.41" y1="382.13" x2="696.17" y2="239.37" href="#linear-gradient"/>
              <linearGradient id="linear-gradient-4" x1="617.61" y1="446.33" x2="760.37" y2="303.57" href="#linear-gradient"/>
              <linearGradient id="linear-gradient-5" x1="572.15" y1="400.87" x2="714.91" y2="258.11" href="#linear-gradient"/>
            </defs>
            ...
            <path fill="url(#linear-gradient)" d="M740,310.89l-35.8-62a32.46,32.46,0,0,0-13-12.55,24.17,24.17,0,0,0-3.43-1.58,32.49,32.49,0,0,0-12-2.3H604.19a32.52,32.52,0,0,0-12,2.3,23.44,23.44,0,0,0-3.41,1.58l-.09.09a32.38,32.38,0,0,0-13,12.46l-35.78,62a32.51,32.51,0,0,0-4.35,17.56v.05a28.73,28.73,0,0,0,.33,3.71,32.5,32.5,0,0,0,4,11.54l35.78,62a32.39,32.39,0,0,0,8,9.24,31.86,31.86,0,0,0,3,2.11,32.83,32.83,0,0,0,17.51,5.08h71.59a32.86,32.86,0,0,0,17.49-5.06,29.41,29.41,0,0,0,3-2.15,31.82,31.82,0,0,0,8-9.22l35.8-62a32.5,32.5,0,0,0,4-11.54,25.92,25.92,0,0,0,.33-3.64A32.57,32.57,0,0,0,740,310.89ZM731.87,339l-35.81,62a22.13,22.13,0,0,1-2.55,3.59,23.74,23.74,0,0,1-8.18,6.05,23.51,23.51,0,0,1-9.55,2.06H604.19a23.55,23.55,0,0,1-17.7-8.11,21.53,21.53,0,0,1-2.55-3.59l-35.81-62a22,22,0,0,1-1.8-4,22.63,22.63,0,0,1-1.18-10.11,23.25,23.25,0,0,1,3-9.29l35.81-62a23.31,23.31,0,0,1,15.88-11.28,22.56,22.56,0,0,1,4.37-.42h71.59a22.71,22.71,0,0,1,4.37.42h0a23.08,23.08,0,0,1,9.33,4,22.76,22.76,0,0,1,6.55,7.24l35.81,62a23.23,23.23,0,0,1,3,9.29A22.92,22.92,0,0,1,733.69,335,25.34,25.34,0,0,1,731.87,339Z"/>
            <path fill="url(#linear-gradient-2)" d="M695.37,240.53l-5.86,5.86-39.3,39.17-1.73,1.72a12,12,0,0,1-17,0l-1.72-1.72-39.31-39.19-5.86-5.84,4.09-4.09.09-.09a23.44,23.44,0,0,1,3.41-1.58l7.61,7.58,38.36,38.24a2.58,2.58,0,0,0,3.64,0l38.33-38.24h0l7.58-7.58a24.17,24.17,0,0,1,3.43,1.58Z"/>
            <path fill="url(#linear-gradient-3)" d="M609.58,354.69l-.59,2.24-14.35,53.75-2.12,8-5.84-1.56a31.86,31.86,0,0,1-3-2.11l2.77-10.37,13.94-52.38a2.59,2.59,0,0,0-1.82-3.14L546.33,335l-10.4-2.81a28.73,28.73,0,0,1-.33-3.71v-.05l1.54-5.69,8,2.15,53.58,14.44,2.34.64A12.08,12.08,0,0,1,609.58,354.69Z"/>
            <path fill="url(#linear-gradient-4)" d="M744.39,328.57a25.92,25.92,0,0,1-.33,3.64L733.69,335l-52.33,14.11a2.58,2.58,0,0,0-1.8,3.14l14,52.38L696.27,415a29.41,29.41,0,0,1-3,2.15l-5.81,1.54-2.13-8L671,356.93l-.59-2.24A12,12,0,0,1,678.9,340l2.34-.64,53.6-14.44,8-2.15Z"/>
            <path fill="url(#linear-gradient-5)" d="M681.24,339.35a15.11,15.11,0,0,0-1.49-3.57L652.5,288.56a14.52,14.52,0,0,0-2.29-3,14.44,14.44,0,0,0-22.72,3l-27.27,47.22a15.11,15.11,0,0,0-1.49,3.57A14.45,14.45,0,0,0,609,356.93a14.1,14.1,0,0,0,3.73.5h54.53a14.46,14.46,0,0,0,14-18.08ZM612.72,348a5,5,0,0,1-4.3-7.47l27.25-47.23a5,5,0,0,1,8.63,0l27.27,47.23a5,5,0,0,1-4.32,7.47Z"/>
          </svg>
        </div>
        <span class="text-base font-display font-black bg-gradient-to-r from-secondary-800 to-secondary-700 bg-clip-text text-transparent">8020 Rule</span>
        <span class="text-base font-display font-black text-primary-500 ml-0.5">AI</span>
      </div>
    </a>
